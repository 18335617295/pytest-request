...
class PerformanceServiceEndCheck:

    @staticmethod
    def check(cls, param):
        CodeCheck.tp_code_check(cls)
        time.sleep(1)
        PerformanceServiceEndCheck.tp_order_check(cls, param)
    ...
    def tp_order_check(cls, param):
        ...
        cls.assert_equal(db_result["order_status"], 72, "tp_order 订单状态 校验失败")
        ...
        cls.assert_equal(db_result["service_status"], 4, "tp_order 服务状态 校验失败")